		...
		EloConfig: []TextConfig{
			{
				Font:     "fonts/xolonium.ttf",
				FontSize: 10,
				Pos:      Position{X: 75.0, Y: 37.0},
				Color:    []qstr.RGBColor{{1.0, 1.0, 0.5}},
			},
			{
				Font:     "fonts/xolonium.ttf",
				FontSize: 10,
				Pos:      Position{X: 175.0, Y: 37.0},
				Color:    []qstr.RGBColor{{1.0, 1.0, 0.5}},
			},
			{
				Font:     "fonts/xolonium.ttf",
				FontSize: 10,
				Pos:      Position{X: 275.0, Y: 37.0},
				Color:    []qstr.RGBColor{{1.0, 1.0, 0.5}},
			},
		},
		WinPctLabelConfig: TextConfig{
